      ...
      <div className="mx-auto w-full max-w-6xl">
        <div className="grid grid-cols-1 place-items-center text-center">
          <PrismicRichText
            ...
            components={{
              heading1: ({ children }) => (
                <h1 className="text-5xl md:text-7xl font-bold leading-tight font-display text-slate-700 tracking-tight">
                  {children}
                </h1>
              ),
            }}
          ...
          <PrismicRichText
            ...
            components={{
              paragraph: ({ children }) => (
                <p className="text-2xl text-center font-body leading-10 text-slate-600 mb-4 md:mb-8 max-w-md">
                  {children}
                </p>
              ),
            }}
